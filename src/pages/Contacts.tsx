      ...
      <section className="bg-white py-20">
        <div className="container-page grid gap-8 lg:grid-cols-[0.8fr_1fr]">
          <div className="grid gap-5">
            <Card>
              <Mail className="h-8 w-8 text-teal-700" aria-hidden="true" />
              <h2 className="mt-4 text-2xl font-black text-slate-950">Email</h2>
              <a className="mt-2 block text-lg font-bold text-teal-700" href="mailto:info@anilp.it">
                info@anilp.it
              </a>
            </Card>
            <Card>
              <MapPin className="h-8 w-8 text-teal-700" aria-hidden="true" />
              <h2 className="mt-4 text-2xl font-black text-slate-950">Sede e PEC</h2>
              <p className="mt-2 leading-7 text-slate-600">PEC in fase di attivazione</p>
              <p className="leading-7 text-slate-600">Sede legale in fase di definizione</p>
            </Card>
            <Card>
              <h2 className="text-2xl font-black text-slate-950">Social</h2>
